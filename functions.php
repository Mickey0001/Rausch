...
function codeian_work_type() {
	...
	$labels = array(
		'name'                  => _x( 'Work Portfolio', 'Post Type General Name', 'codeian_com' ),
		'singular_name'         => _x( 'Work Portfolio', 'Post Type Singular Name', 'codeian_com' ),
		'menu_name'             => __( 'Work Portfolio', 'codeian_com' ),
		'name_admin_bar'        => __( 'Work Portfolio', 'codeian_com' ),
		'archives'              => __( 'WorkArchives', 'codeian_com' ),
		'attributes'            => __( 'Work Attributes', 'codeian_com' ),
		'parent_item_colon'     => __( 'Parent Work:', 'codeian_com' ),
		'all_items'             => __( 'All Works', 'codeian_com' ),
		'add_new_item'          => __( 'Add New Work', 'codeian_com' ),
		'add_new'               => __( 'Add New', 'codeian_com' ),
		'new_item'              => __( 'New Work', 'codeian_com' ),
		'edit_item'             => __( 'Edit Work', 'codeian_com' ),
		'update_item'           => __( 'Update Work', 'codeian_com' ),
		'view_item'             => __( 'View Work', 'codeian_com' ),
		'view_items'            => __( 'View Works', 'codeian_com' ),
		'search_items'          => __( 'Search Work', 'codeian_com' ),
		'not_found'             => __( 'Not found', 'codeian_com' ),
		'not_found_in_trash'    => __( 'Not found in Trash', 'codeian_com' ),
		'featured_image'        => __( 'Featured Image', 'codeian_com' ),
		'set_featured_image'    => __( 'Set featured image', 'codeian_com' ),
		'remove_featured_image' => __( 'Remove featured image', 'codeian_com' ),
		'use_featured_image'    => __( 'Use as featured image', 'codeian_com' ),
		'insert_into_item'      => __( 'Insert into Work', 'codeian_com' ),
		'uploaded_to_this_item' => __( 'Uploaded to this Work', 'codeian_com' ),
		'items_list'            => __( 'Works list', 'codeian_com' ),
		'items_list_navigation' => __( 'Works list navigation', 'codeian_com' ),
		'filter_items_list'     => __( 'Filter Works list', 'codeian_com' ),
	);
	$args = array(
		'label'                 => __( 'Work Portfolio', 'codeian_com' ),
		'labels'                => $labels,
...
// 	$labels = array(
// 		'name'                       => _x( 'Categories', 'Taxonomy General Name', 'codeian_com' ),
// 		'singular_name'              => _x( 'Category', 'Taxonomy Singular Name', 'codeian_com' ),
// 		'menu_name'                  => __( 'Category', 'codeian_com' ),
// 		'all_items'                  => __( 'All Items', 'codeian_com' ),
// 		'parent_item'                => __( 'Parent Item', 'codeian_com' ),
// 		'parent_item_colon'          => __( 'Parent Item:', 'codeian_com' ),
// 		'new_item_name'              => __( 'New Item Name', 'codeian_com' ),
// 		'add_new_item'               => __( 'Add New Item', 'codeian_com' ),
// 		'edit_item'                  => __( 'Edit Item', 'codeian_com' ),
// 		'update_item'                => __( 'Update Item', 'codeian_com' ),
// 		'view_item'                  => __( 'View Item', 'codeian_com' ),
// 		'separate_items_with_commas' => __( 'Separate items with commas', 'codeian_com' ),
// 		'add_or_remove_items'        => __( 'Add or remove items', 'codeian_com' ),
// 		'choose_from_most_used'      => __( 'Choose from the most used', 'codeian_com' ),
// 		'popular_items'              => __( 'Popular Items', 'codeian_com' ),
// 		'search_items'               => __( 'Search Items', 'codeian_com' ),
// 		'not_found'                  => __( 'Not Found', 'codeian_com' ),
// 		'no_terms'                   => __( 'No items', 'codeian_com' ),
// 		'items_list'                 => __( 'Items list', 'codeian_com' ),
// 		'items_list_navigation'      => __( 'Items list navigation', 'codeian_com' ),
// 	);
// 	$args = array(
// 		'labels'                     => $labels,
// 		'hierarchical'               => false,
...
function work_details_save( $post_id ) {
	...
	if ( ! isset( $_POST['work_details_nonce'] ) || ! wp_verify_nonce( $_POST['work_details_nonce'], '_work_details_nonce' ) ) return;
